# -*- coding: utf-8 -*-
"""An Introduction to Generative Adversarial Networks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19zor5Lx95YcE-0-mkEoYhphKzxWtOOqS
...
"""build the discriminator: input mnist dataset: 784"""
...
class Discriminator(nn.Module):
  def __init__(self, img_dim):
    ...
    self.disc = nn.Sequential(
        ...
        nn.Linear(128, 1), # determine fake or real
        nn.Sigmoid()
    )
...
"""build the generator: make image from the noise: z"""
